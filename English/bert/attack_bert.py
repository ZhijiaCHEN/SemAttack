...
def cw_word_attack(model, test_data):
    print(f"Start attacking, function={args.function}, {'untargeted' if args.untargeted else 'targeted'}, number of testing samples = {len(test_data)}")
    adv_correct = 0
    targeted_success = 0
